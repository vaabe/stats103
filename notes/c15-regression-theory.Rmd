...
But this assumption can be relaxed, since the CLT gives asymptotically normal errors even when they aren't normally distributed, provided $n$ is large enough. 
...
**In a linear model with homoscedastic errors, the LS estimator is Best Linear Unbiased Estimator**^[Or BLUE, as the cool kids say.].  
