...
You can see how omitting variables that are correlated with the predictors can result in a loss of relevant information to the problem---it can result in strongly biased regression coefficients, and severe misunderstandings about the nature of the relationship between two variables.  
