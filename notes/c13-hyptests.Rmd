...
In this example the observed value is clearly in the rejection region. You can thus reject the null at the $\alpha = 0.05$ level, and conclude that true mean hourly wage gap is $\mu \neq 12.356$.  

Note, if you had used a significance level of $\alpha = 0.01$ to conduct the test, you would have reached a different conclusion: 
...
Clearly, with a significance level of $\alpha = 0.01$, the observed value does *not* fall in the rejection, and you cannot thus reject the null. The choice of significance level can make or break the fate of a hypothesis.  
