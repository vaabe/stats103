...
Of course, the easiest way to get around this problem is to do as few simultaneous tests as necessary---this will ensure a small FWER. But in contexts where multiple testing is necessary, there are a number of methods for dealing with this problem. Below we will briefly discuss two: the **Bonferonni** method and the **Benjamini-Hochberg** method. 
