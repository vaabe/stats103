...
The code below generates 20 random samples and plots a 95\% confidence interval for the mean based on each sample. The pink line is the true mean of the population.  
