---
title: 'chapter 16 Inference from Regression Models, Part I'
output:
  tufte::tufte_html:
...
# 16--3 Hypothesis tests on regression coefficients
...
# 16--4 Checking Residuals and Outliers 
...
- look for an even spread of points throughout the plot. If the points are more vertically spread certain areas (like a triangle pointing left or right), this indicates the model has heteroscedastic errors (the errors have non-constant variance)
...
# 16--5 The Problem of Multicollinearity 
