...
We can use the hypothesis testing framework to test whether the predictor variables in a given model are really significant. Consider the multiple regression model of temperature, using vegetation, albedo, building height, and population density as predictors:
