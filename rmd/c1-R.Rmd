...
To run code you have written in the script editor, click 'Run' (top right) ^[Or use a keyboard shortcut. Mac: cmd+enter. Windows: cntrl+enter.]. The current line (or the selected lines) will be run in the console, producing an output.  
...
Sometimes code you run will return an error. Fear not. Just read the error message and try to intuit what it means. 
