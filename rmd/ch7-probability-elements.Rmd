---
title: "7 Probability Spaces, Axioms"
chapter: "7"
part: "pt2"
output:
  html_document:
...
Statistical inference is based on ideas from probability theory. These chapters will introduce some of the basic formalism. 

\ 

# 7--2 Random Processes

A random process as anything that gives rise to an **outcome**. Tossing a coin or rolling a die are two classic examples.  

Many experiments/phenomena can be modeled as random processes, even ones whose outcomes seem nonrandom. E.g.--whether the stock market will go up or down tomorrow, or whether a certain candidate will win an election, or whether the sun will rise tomorrow--can be thought of as random processes in the sense that there will *necessarily* be an outcome, even if the outcome may appear to have a deterministic bent.     
